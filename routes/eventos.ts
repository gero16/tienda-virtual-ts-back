...
router.post("/", authenticate, authorize("admin"), async (req: Request, res: Response) => {
  try {
    const { slug, titulo, descripcion, theme, fecha_inicio, fecha_fin, activo } = req.body;
    ...
    const evento = await Evento.create({ slug: slug.toLowerCase(), titulo, descripcion, theme, fecha_inicio, fecha_fin, activo });
